...
export default function LoginPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      // The animated welcome screen is a nice first impression, but showing
      // it on every single login adds ~3s of friction to the most frequent
      // action in the app — only play it the first time this browser logs in.
      let seenWelcome = false;
      try {
        seenWelcome = localStorage.getItem("lorgric_seen_welcome") === "true";
      } catch {
        // localStorage unavailable (e.g. private mode) — just show the splash
      }
      ...
      try {
        localStorage.setItem("lorgric_seen_welcome", "true");
      } catch {
        // ignore — worst case the splash reappears next login
      }
      ...
      <div className="w-full max-w-md space-y-6">
        ...
        <div className="flex flex-col items-center gap-3">
          ...
          <div className="text-center">
            <h1 className="text-2xl font-light tracking-tight text-[#fcfcf7]">Lorgric</h1>
            <p className="text-sm text-[#fcfcf7]/70">Northern Ghana&apos;s Agricultural Marketplace</p>
          </div>
        </div>
        ...
        <Card className="bg-[#fcfcf7] border border-[#eeeee9] rounded-2xl">
          <CardHeader className="pb-4">
            <CardTitle className="text-xl font-light tracking-tight text-[#1c3a13]">Welcome back</CardTitle>
            <CardDescription className="text-[#1c3a13]/50">Sign in with your phone number</CardDescription>
          </CardHeader>
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    required
                    autoComplete="tel"
                    className="pl-9 bg-[#fcfcf7] border border-[#eeeee9] rounded-lg focus:ring-[#1c3a13]"
                  />
                </div>
              </div>
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <Input
                    ...
                    className="pr-10 bg-[#fcfcf7] border border-[#eeeee9] rounded-lg focus:ring-[#1c3a13]"
                  />
                  <button
                    type="button"
          ...
          <CardFooter className="flex-col gap-2 border-t border-[#eeeee9] pt-4">
            <p className="text-sm text-[#1c3a13]/70">
              ...
              <Link href="/auth/register" className="text-[#1c3a13] underline hover:no-underline">
                Create one for free
              </Link>
            </p>
          </CardFooter>
