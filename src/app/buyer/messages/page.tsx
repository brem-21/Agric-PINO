...
export default function MessagesPage() {
  ...
  const fetchMessages = useCallback(async (convId: string, isManual = false) => {
    try {
      ...
      setMessages((prev) => {
        // Find new messages from the other person
        ...
        if (fresh.length > 0) {
          ...
          // Scroll if near bottom, otherwise show banner + scroll button
        ...
        // Keep optimistic temp messages until replaced by real ones
  ...
  return (
    <div className="flex h-[calc(100vh-8rem)] border border-[#eeeee9] rounded-2xl overflow-hidden">
      {/* Sidebar */}
      <div className="w-72 border-r border-[#eeeee9] flex flex-col bg-[#fcfcf7]">
        <div className="p-4 border-b border-[#eeeee9] flex items-center justify-between">
          <div className="flex items-center gap-2">
            <h2 className="font-medium text-[#1c3a13]">Messages</h2>
            <span className="flex items-center gap-1 text-[10px] text-[#d3fa99] font-medium bg-[#1c3a13] px-1.5 py-0.5 rounded-full">
          ...
          <button
            ...
            className="p-1.5 rounded-full text-[#1c3a13]/50 hover:text-[#1c3a13] hover:bg-[#eeeee9] transition-colors"
            title="New message"
          >
        ...
        {showSearch && (
          <div className="border-b border-[#eeeee9] p-3">
            <div className="relative mb-2">
              ...
              <input
                ...
                className="w-full pl-8 pr-3 py-1.5 text-sm border border-[#eeeee9] bg-[#fcfcf7] rounded-lg focus:outline-none focus:ring-2 focus:ring-[#1c3a13]/20 focus:border-[#1c3a13] text-[#1c3a13] placeholder-[#1c3a13]/40"
              />
              {searchLoading && (
            ...
            <div className="space-y-1 max-h-52 overflow-y-auto">
              {searchResults.map((u) => (
                <button
                  ...
                  className="w-full text-left flex items-center gap-2.5 px-2 py-2 rounded-full hover:bg-[#eeeee9] transition-colors"
                >
            ...
            <div className="p-1 space-y-1">
              {conversations.map((conv) => (
                <button
                  ...
                  className={`w-full text-left p-3 transition-colors rounded-xl ${
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    {conv.unread > 0 && (
                      <span className="ml-auto bg-[#d3fa99] text-[#1c3a13] text-xs rounded-full min-w-[1.25rem] h-5 flex items-center justify-center px-1 flex-shrink-0 font-bold">
                        {conv.unread}
                      </span>
                    )}
                  </div>
          ...
          <>
            ...
            {newMsgBanner && (
              <button
                ...
                className="flex items-center justify-center gap-2 bg-[#d3fa99] text-[#1c3a13] text-xs font-medium py-1.5 px-3 hover:bg-[#d3fa99]/80 transition-colors rounded-full mx-4 mt-2"
              >
            ...
            {showScrollBtn && (
              <button
                onClick={scrollToBottom}
                className="absolute bottom-20 right-6 flex items-center gap-1.5 rounded-full bg-[#1c3a13] text-[#fcfcf7] text-xs font-medium px-3 py-1.5 hover:bg-[#2a5219] transition-colors"
            ...
            <div className="border-t border-[#eeeee9]">
              <div className="p-3 flex gap-2 items-center">
                <Input
                  ...
                  className="flex-1 bg-[#fcfcf7] border-[#eeeee9] rounded-full text-[#1c3a13] placeholder-[#1c3a13]/40 focus:border-[#1c3a13] focus:ring-[#1c3a13]/20"
                />
                <Button
                  onClick={sendMessage}
