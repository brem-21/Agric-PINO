...
import { OnlineToggle } from "@/components/shared/online-toggle";
    ...
    return (
      <>
        <div className={cn("flex items-center border-b border-white/10 py-5", isCollapsed ? "justify-center px-2" : "justify-between px-4")}>
          {!isCollapsed && (
            <Link href="/logistics/dashboard" className="flex items-center gap-2">
              ...
              <span className="font-medium tracking-tight text-[#fcfcf7] text-lg">
        ...
        <div className="border-t border-white/10 p-4 space-y-3">
          ...
          <OnlineToggle className="w-full justify-center" iconOnly={isCollapsed} />
          <SignOutButton
            iconOnly={isCollapsed}
            className={cn("text-[#fcfcf7]/60 hover:text-[#fcfcf7] hover:bg-white/10 rounded-full", isCollapsed ? "w-full justify-center" : "w-full justify-start")}
          />
        </div>
      </>
    );
    ...
    <>
      <div className="lg:hidden flex items-center justify-between bg-[#1c3a13] px-4 py-3">
        <Link href="/logistics/dashboard" className="flex items-center gap-2">
          ...
          <span className="font-medium tracking-tight text-[#fcfcf7]">
            Lorgric<span className="text-[#d3fa99]">●</span>
          </span>
        </Link>
        <button
